...
export class Neo4jConnectionManager {
        ...
        try {
            ...
            if (!allowedSchemes.includes(scheme)) {
                ...
                if (scheme === 'http' || scheme === 'https') {
                    throw new Error(`HTTP scheme detected: "${scheme}". ` +
                ...
                throw new Error(`Invalid Neo4j URI scheme: "${scheme}". ` +
    ...
    constructor(config) {
        ...
        try {
            ...
            throw new Error(`Failed to connect to Neo4j at ${this.config.uri}. ` +
